    ...
    ***************************************************************************** */
    ...
    var NgbModalWindow = /** @class */ (function () {
        function NgbModalWindow(_document, _elRef, _zone) {
             ...
             */
            function () {
                rxjs.fromEvent(_this._elRef.nativeElement, 'keydown')
                    .pipe(operators.takeUntil(_this.dismissEvent), 
                // tslint:disable-next-line:deprecation
                operators.filter((/**
                 * @param {?} e
                 * @return {?}
                ...
                /** @type {?} */
                var mouseDowns$ = rxjs.fromEvent(_this._elRef.nativeElement, 'mousedown')
                    .pipe(operators.takeUntil(_this.dismissEvent), operators.map((/**
                 * @param {?} e
                 * @return {?}
                 */
                function (e) { return _this.backdrop === true && _this._elRef.nativeElement === e.target; })));
                rxjs.fromEvent(_this._elRef.nativeElement, 'mouseup')
                    .pipe(operators.takeUntil(_this.dismissEvent), operators.withLatestFrom(mouseDowns$), operators.filter((/**
                 * @param {?} __0
                 * @return {?}
                 */
                function (_a) {
